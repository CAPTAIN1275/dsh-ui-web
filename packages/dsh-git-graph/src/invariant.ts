/**
 * Package-owned invariant companion for `@captain1275/dsh-client-ui-git-graph`.
 ...
 * @module @captain1275/dsh-client-ui-git-graph/invariant
 */
...
const PACKAGE_NAME = '@captain1275/dsh-client-ui-git-graph'
