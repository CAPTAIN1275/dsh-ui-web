# @captain1275/dsh-client-ui-skin-dragon-heir
...
推荐先装皮肤全家桶聚合包 `@captain1275/dsh-skins` 一次到位；只装本皮肤时用下列 link 命令。

```sh
# 装全部皮肤（推荐）
dsh plugin --profile web add @captain1275/dsh-skins
# 或单独装本皮肤
dsh plugin --profile web add @captain1275/dsh-client-ui-skin-dragon-heir
