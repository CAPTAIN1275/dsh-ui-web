...
`@captain1275/dsh-client-ui-skin-center`（cordis 插件 id `ui-skin-center`）把皮肤列表/试穿/应用
...
推荐先装皮肤全家桶聚合包 `@captain1275/dsh-skins` 一次到位（含全部皮肤与皮肤中心）；
只装本包时用下列 link 命令。
...
# 或单独装皮肤中心
dsh plugin --profile web add @captain1275/dsh-client-ui-skin-center
...
pnpm --filter @captain1275/dsh-client-ui-skin-center run bundle
```
...
#   - insert:
#       - id: ui-skin-center
#         name: '@captain1275/dsh-client-ui-skin-center'
