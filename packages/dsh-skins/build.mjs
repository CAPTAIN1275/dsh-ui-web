 ...
 *     profile node_modules can resolve @captain1275/dsh-client-ui-skin-<id>)
 ...
 *   pnpm --filter @captain1275/dsh-skins build
 */
 ...
 * loadable as @captain1275/dsh-client-ui-skin-<id> from the profile. Mirrors the
...
function renderCarrierPackageJson(sourcePkg) {
  const pkg = {
    ...
    description: 'Bundled skin inside @captain1275/dsh-skins (' + sourcePkg.name + ').',
    type: 'module',
    main: 'lib/index.js',
    exports: {
      '.': './lib/index.js',
