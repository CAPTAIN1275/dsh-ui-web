 ...
 * installed aggregate package (@captain1275/dsh-web-ui-all) and its family
...
export const FAMILY_SCOPE = '@captain1275/'

/** The aggregate package that is the canonical update entry point. */
export const AGGREGATE_PACKAGE = '@captain1275/dsh-web-ui-all'

/** Fallback anchor: this plugin's own package when the aggregate is absent. */
export const SELF_PACKAGE = '@captain1275/dsh-remote-web-ui'
