/**
 * Package-owned invariant companion for `@captain1275/dsh-remote-web-ui`.
 * @module @captain1275/dsh-remote-web-ui/invariant
 */
...
const PACKAGE_NAME = '@captain1275/dsh-remote-web-ui'
