...
import { TaskBoard, type CurrentSessionHandle } from './board/TaskBoard.tsx'
 ...
 * @param sessions - current-session handle (list store + open) for the board's
 *   "当前会话" block.
 * @returns disposer unmounting the tree and restoring the column.
 */
export function mountBoard(
  controller: BoardController,
  sessions: CurrentSessionHandle,
): () => void {
  ...
  const ensure = (): void => {
    ...
    root.render(<TaskBoard controller={controller} sessions={sessions} />)
  }
