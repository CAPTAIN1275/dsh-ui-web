...
```sh
# 推荐：直接从 npm 安装
dsh plugin --profile web add @captain1275/dsh-client-ui-task-board
...
```json
{
  "dependencies": { "@captain1275/dsh-client-ui-task-board": "link:/Users/zcl/code/dsh-web-ui/packages/dsh-task-board" },
  "dsh": { "profile": { "bundles": [ "...", "@captain1275/dsh-client-ui-task-board" ] } }
}
```
